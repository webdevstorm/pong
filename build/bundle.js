...
function () {
  ...
  _createClass(Game, [{
    ...
    value: function render() {
      ///empty out game elements before reappending
      this.gameElement.innerHTML = "";
      var svg = document.createElementNS(_settings__WEBPACK_IMPORTED_MODULE_0__["SVG_NS"], "svg");
      svg.setAttributesNS(null, "width", this.width);
      svg.setAttributesNS(null, "height", this.height);
      svg.setAttributesNS(null, "viewbox", "0 0 ".concat(this.width, " ").concat(this.height));
      svg.setAttributesNS(null, "version", "1.1");
